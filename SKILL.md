---
name: geodot
description: Downloads satellite map tiles and prepares metadata-only visual place recognition datasets from Python, JavaScript, or Rust CLIs and libraries.
---
